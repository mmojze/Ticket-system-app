...
public class FormListarLugares extends JPanel implements ActionListener {
	...
	public FormListarLugares(PanelManager panelManager) { 
		
		this.panelManager = panelManager;
		
	}
	
	public void armarFormListarLugaresList() {
